...
https://gitee.com/liruizhi/oh-my-zsh
--------------------------------------------------------------------------------
...
wget https://gitee.com/liruizhi/oh-my-zsh/raw/master/auto-install-and-update.sh && chmod +x auto-install-and-update.sh && source ./auto-install-and-update.sh && rm -rf oh-my-zsh auto-install-and-update.sh
```
--------------------------------------------------------------------------------
